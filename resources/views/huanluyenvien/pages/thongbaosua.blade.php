				...
				<div class="row">
					...
					<div class="col-md-8 col-md-offset-2">
						<div class="kode_player_item">
							...
							<form action="huan-luyen-vien/thong-bao/sua/{{$thongbao->id}}" method="POST">
							{{ csrf_field() }}
								...
								<div class="col-md-12">
									...
									<div class="col-md-9">
										<div class="kode_contant_field">
											<input type="text" placeholder="Tiêu đề" value="{{$thongbao->TieuDe}}" name="TieuDe" required>
										</div>
									</div>
								</div>
								...
								<div class="col-md-12">
									...
									<div class="col-md-9">
										<div class="kode_contant_area">
											<textarea name="NoiDung" placeholder="Nội dung thông báo" required>{{$thongbao->NoiDung}}</textarea>
										</div>
									</div>
								</div>
