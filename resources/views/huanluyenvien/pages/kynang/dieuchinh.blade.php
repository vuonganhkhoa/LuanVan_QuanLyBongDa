...
<div class="kode-content">
	...
	<section>
		<div class="container">
			...
			<form class="form-horizontal" method="POST" action="huan-luyen-vien/ky-nang-cau-thu/dieu-chinh/{{$CauThuCanDieuChinh->id}}">
				{{ csrf_field() }}
					...
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<div class="col-md-8 col-sm-8">
								<div class="panel-group">
									<div class="panel panel-default">
										<div class="panel-heading">Các kỹ năng cầu thủ</div>
										<div class="panel-body">
                                            @foreach ($DanhSachKyNang as $kynang)
                                            <div class="col-md-4" style="margin: 7px">
											<label>
                                                <input 
                                                    type="checkbox" 
                                                    name="KyNangDieuChinh[]"
                                                    @foreach($KyNangCauThu as $kynangcauthu)
                                                    {{$kynang->id===$kynangcauthu->idKyNang?'checked':''}}
													@endforeach
													value="{{ $kynang->id }}"
                                                > 
                                                     {{$kynang->TenKyNang}} 
