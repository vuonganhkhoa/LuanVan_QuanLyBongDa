      ...
      <div class="main-page">
        ...
        <div class="row">
            ...
            <div class="form-three widget-shadow">
              <form method="POST" class="form-horizontal" action="nhan-vien-y-te/thuoc/them" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                  ...
                  <div class="col-md-12">
                    <div class="form-group {{ $errors->has('tenthuoc') ? 'has-error' : '' }}">
                      ...
                      <div class="col-md-3">
                        <input style="height: 30px; width: 500px" class="form-control1" placeholder="Nhập tên thuốc" type="text" name="tenthuoc">
                      </div>
