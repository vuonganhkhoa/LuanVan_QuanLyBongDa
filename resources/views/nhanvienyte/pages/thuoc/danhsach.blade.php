...
@section('content')
	<div id="page-wrapper">
			...
			<div class="main-page">
				<h3 class="title1">Danh sách Thuốc</h3>
				<div class="tables">
						...
						<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
							...
							<tbody> 
								...
								<tr class="odd gradeX">
										<td>{{ 	$stt }}</td>
										<td>{{ 	$t->TenThuoc  }}</td>
										<td width="500px">{{  $t->GhiChu  }}</td> 
										<td class="text-center" style="width: 135px">
											<a onclick="return XacNhanXoa('Bạn có chắc muốn xóa?')" href="nhan-vien-y-te/thuoc/xoa/{{ $t->id }}" title="Xóa" class="btn btn-danger"><i class="fa fa-ban" ></i> Xóa</a>

											<a href="nhan-vien-y-te/thuoc/sua/{{ $t->id }}" title="Sửa" class="btn btn-info"><i class="fa fa-edit" ></i> Sửa</a>
										</td>
								</tr> 
								<?php $stt++; ?>
								@endforeach
