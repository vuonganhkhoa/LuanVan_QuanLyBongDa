...
@section('content')
	...
	<div id="page-wrapper">
        ...
        <div class="row">
            <h3 class="title1">Thêm kỹ năng :</h3>
            ...
            @endif
                ...
                <div class="form-three widget-shadow">
                    <form method="POST" class="form-horizontal" action="admin/ky-nang/them" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                            <div class="form-group {{ $errors->has('tenkynang') ? 'has-error' : '' }}">
                              ...
                              <div class="col-md-5">
                                <input type="text" class="form-control" placeholder="Nhập tên kỹ năng" name="tenkynang">
                              </div>
                              <div class="col-md-4">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group {{ $errors->has('chitiet') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control " rows="8" name="chitiet" id="chitiet"></textarea>
