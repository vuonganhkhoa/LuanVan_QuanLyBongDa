...
@section('content')
	...
	<div id="page-wrapper">
        ...
        <div class="row">
            <h3 class="title1">Thêm Vai trò :</h3>
            ...
            @endif
                ...
                <div class="form-three widget-shadow">
                    <form method="POST" class="form-horizontal" action="admin/vai-tro/them" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                            <div class="form-group {{ $errors->has('tenvaitro') ? 'has-error' : '' }}">
                              ...
                              <div class="col-md-5">
                                <input type="text" class="form-control" placeholder="Nhập tên kỹ năng" name="tenvaitro">
                              </div>
                              <div class="col-md-4">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group {{ $errors->has('mieuta') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control " rows="8" name="mieuta" id="mieuta"></textarea>
