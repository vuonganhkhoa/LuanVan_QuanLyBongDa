...
@section('content')
	...
	<div id="page-wrapper">
			...
			<div class="main-page">
				...
				<div class="row">
						<h3 class="title1">Thêm Vị trí :</h3>
						...
						<div class="form-three widget-shadow">
							<form method="POST" class="form-horizontal" action="admin/vi-tri/them" enctype="multipart/form-data">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group {{ $errors->has('tenvitri') ? 'has-error' : '' }}">
											...
											<div class="col-md-3">
												<input style="height: 30px" placeholder="Nhập tên vị trí" class="form-control1" type="text" name="tenvitri">
											</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group {{ $errors->has('chuthich') ? 'has-error' : '' }}">
											...
											<div class="col-md-3">
												<input style="height: 30px" placeholder="Nhập chú thích" class="form-control1" type="text" name="chuthich">
											</div>
